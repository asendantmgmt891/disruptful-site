...
const models = [
  { name: 'Veyra Stehl', slug: '/models/veyra-stehl', market: 'Yoga • Fitness • Visual inspiration', status: 'Digital creator', tone: 'Yoga and fitness for visual inspiration — mainly for men, but all are welcome. Move better, stress less, and build a stronger mind and body.', description: 'Yoga and fitness for visual inspiration — mainly for men, but all are welcome. Move better, stress less, and build a stronger mind and body.', instagram: 'https://www.instagram.com/veyrastehl/', premium: 'https://onlyfans.com/veyrastehl', mym: 'https://mym.fans/Veyrastehl', image: '/images/models/veyra-stehl.jpg', gallery: ['/images/models/veyra-stehl-yoga-rocks.jpg', '/images/models/veyra-stehl-profile-side.jpg', '/images/models/veyra-stehl-yoga-lunge.jpg', '/images/models/veyra-stehl-blue-studio.jpg', '/images/models/veyra-stehl-sunlit-portrait.jpg', '/images/models/veyra-stehl-car-duo.jpg', '/images/models/veyra-stehl-car-portrait.jpg'] },
  { name: 'Emyra Vesce', slug: '/models/emyra-vesce', market: 'Lifestyle • Fashion • Visual inspiration', status: 'Digital creator', tone: 'A polished visual presence with confident lifestyle and fashion-forward content direction.', description: 'A digital creator with a polished visual presence, confident lifestyle imagery, and fashion-forward content direction.', image: '/images/models/emyra-vesce.jpg', gallery: ['/images/models/emyra-vesce-purple-studio.jpg', '/images/models/emyra-vesce-red-car.jpg', '/images/models/emyra-vesce-car-interior.jpg', '/images/models/emyra-vesce-side-car.jpg', '/images/models/emyra-vesce-sunlit-closeup.jpg', '/images/models/emyra-vesce-car-exterior.jpg', '/images/models/emyra-vesce-yellow-car-closeup.jpg', '/images/models/emyra-vesce-in-car-duo.jpg', '/images/models/emyra-vesce-graffiti-yoga.jpg', '/images/models/emyra-vesce-graffiti-cobra.jpg', '/images/models/emyra-vesce-outdoor-backbend.jpg'] },
  { name: 'Siyenna Luyxe', slug: '/models/siyenna-luyxe', market: 'Desert • Fitness • Visual inspiration', status: 'Digital creator', tone: 'A confident visual creator with desert-lit fitness imagery and bold, polished brand presence.', description: 'A digital creator with confident desert-lit fitness imagery, bold visual identity, and polished brand presence.', image: '/images/models/siyenna-luyxe.jpg', gallery: ['/images/models/siyenna-luyxe-seated-yoga.jpg', '/images/models/siyenna-luyxe-desert-pink.jpg', '/images/models/siyenna-luyxe-desert-black.jpg', '/images/models/siyenna-luyxe-desert-turquoise.jpg'] },
]
