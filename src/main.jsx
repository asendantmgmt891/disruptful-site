...
const models = [
  ...
  { name: 'Emyra Vesce', slug: '/models/emyra-vesce', market: 'Lifestyle • Fashion • Visual inspiration', status: 'Digital creator', tone: 'A polished visual presence with confident lifestyle and fashion-forward content direction.', description: 'A digital creator with a polished visual presence, confident lifestyle imagery, and fashion-forward content direction.', image: '/images/models/emyra-vesce.jpg', gallery: ['/images/models/emyra-vesce-purple-studio.jpg', '/images/models/emyra-vesce-red-car.jpg', '/images/models/emyra-vesce-car-interior.jpg', '/images/models/emyra-vesce-side-car.jpg'] },
